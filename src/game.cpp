...
Game::Game(){
  //init texture
  InitTexture();
  fruitShader.Init("/home/bat/24/snake-3d/shaders/f_shader.vert",
		   "/home/bat/24/snake-3d/shaders/f_shader.frag");
  gridShader.Init("/home/bat/24/snake-3d/shaders/grid_shader.vert",
		  "/home/bat/24/snake-3d/shaders/grid_shader.frag");
  pythonShader.Init("/home/bat/24/snake-3d/shaders/p_shader.vert",
		    "/home/bat/24/snake-3d/shaders/p_shader.frag");
  texShader.Init("/home/bat/24/snake-3d/shaders/tx.vert",
		 "/home/bat/24/snake-3d/shaders/tex.frag");
  lightShader.Init("/home/bat/24/snake-3d/shaders/light.vert",
		   "/home/bat/24/snake-3d/shaders/light.frag");
  loadingShader.Init("/home/bat/24/snake-3d/shaders/screen.vert",
		     "/home/bat/24/snake-3d/shaders/screen.frag");
  endLoadingShader.Init("/home/bat/24/snake-3d/shaders/screen.vert",
			"/home/bat/24/snake-3d/shaders/screen.frag");
  //for text
  textShader.Init("/home/bat/24/snake-3d/shaders/text.vert",
		  "/home/bat/24/snake-3d/shaders/text.frag");
...
void Game::InitTexture(){
  ...
  data = stbi_load("/home/bat/24/snake-3d/Graphics/skin2.jpg",&width,&height,&nrChannels,0);
  ...
  glTexParameteri(GL_TEXTURE_2D, GL_TEXTURE_MIN_FILTER, GL_LINEAR_MIPMAP_LINEAR);
  glTexParameteri(GL_TEXTURE_2D, GL_TEXTURE_MAG_FILTER, GL_LINEAR);
  data = stbi_load("/home/bat/24/snake-3d/Graphics/grass3.png",&width,&height,&nrChannels,0);
  
  if(data){
    glTexImage2D(GL_TEXTURE_2D,0,GL_RGBA,width,height,0,GL_RGBA,GL_UNSIGNED_BYTE,data);
    glGenerateMipmap(GL_TEXTURE_2D);
  }else{
    std::cout<<"Could not load texture grasss"<<std::endl;
  }
  stbi_image_free(data);
  ...
  data = stbi_load("/home/bat/24/snake-3d/Graphics/loadingscreen.png",&width,&height,&nrChannels,0);
  if(data){
    glTexImage2D(GL_TEXTURE_2D,0,GL_RGBA,width,height,0,GL_RGBA,GL_UNSIGNED_BYTE,data);
    glGenerateMipmap(GL_TEXTURE_2D);
  }else{
     std::cout<<"Could not load texture loading"<<std::endl;
  }
  stbi_image_free(data);
  ...
  glTexParameteri(GL_TEXTURE_2D, GL_TEXTURE_MAG_FILTER, GL_LINEAR);
  stbi_set_flip_vertically_on_load(true);  
  data = stbi_load("/home/bat/24/snake-3d/Graphics/oversnake.png",&width,&height,&nrChannels,0);
  if(data){
    glTexImage2D(GL_TEXTURE_2D,0,GL_RGBA,width,height,0,GL_RGBA,GL_UNSIGNED_BYTE,data);
    glGenerateMipmap(GL_TEXTURE_2D);
  }else{
